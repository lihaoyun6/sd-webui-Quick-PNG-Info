		...
		if kwargs.get("elem_id") == f"txt2img_gallery":
			...
			with gr.Row():
				...
				with gr.Column(scale=10):
					with gr.Row(elem_classes="image-buttons"):
						show_info_text = gr.Button(value='\u2139\uFE0F',visible=not opts.data.get("qpi_always_show_text", False))
						hide_info_text = gr.Button(value='\u2139\uFE0F',visible=opts.data.get("qpi_always_show_text", False))
